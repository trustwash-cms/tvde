...
const MODULE_CARDS: ModuleCardConfig[] = [
  ...
  },
  {
    ...
    label: 'Uber',
    description: 'Integração e gestão Uber.',
    icon: Car,
    iconClass: 'text-slate-700',
    iconBgClass: 'bg-slate-100',
    canShow: (role) => canAccessDashboardArea(role, 'uber'),
  },
  {
    moduleKey: 'via_verde',
    area: 'via_verde',
    ...
    label: 'Via Verde',
    description: 'Portagens e Via Verde.',
    icon: Nfc,
    iconClass: 'text-emerald-700',
    iconBgClass: 'bg-emerald-50',
    canShow: (role) => canAccessDashboardArea(role, 'via_verde'),
  },
  {
    ...
    label: 'Eletricidade',
    description: 'Consumos e custos de eletricidade.',
    icon: Plug,
    iconClass: 'text-yellow-700',
    iconBgClass: 'bg-yellow-50',
    canShow: (role) => canAccessDashboardArea(role, 'eletricidade'),
  },
  {
    ...
    label: 'Combustível',
    description: 'Abastecimentos e combustível.',
    icon: Fuel,
    iconClass: 'text-orange-700',
    iconBgClass: 'bg-orange-50',
    canShow: (role) => canAccessDashboardArea(role, 'combustivel'),
  },
  {
    ...
    canShow: (role) => canAccessDashboardArea(role, 'pagamentos'),
  },
  {
    moduleKey: 'calendar',
    area: 'calendar',
